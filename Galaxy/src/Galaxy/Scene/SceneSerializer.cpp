...
namespace Galaxy
{
	...
	{
		out << YAML::BeginMap; //Serialization
		out << YAML::Key << "Entity" << YAML::Value << "12345678987654321";
	...
	void SceneSerializer::Serialize(const std::string& filepath)
	{
		...
		out << YAML::BeginSeq; //Entity Sequence
		...
		out << YAML::EndSeq; //Entity Sequence
	...
	bool SceneSerializer::Deserialize(const std::string& filepath)
	{
		...
		GX_CORE_TRACE("Deseriaizing Scene {0}", sceneName);
		...
		if (entities)
		{
			for (auto entity : entities)
			{
				...
				GX_CORE_TRACE("Deserializing entity with ID {0}, name = {1}", uuid, name);
